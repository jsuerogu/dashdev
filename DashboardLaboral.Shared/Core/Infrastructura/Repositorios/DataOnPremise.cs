...
{
    [IndicadorData("OnPremise", "On-Premise")]
    public class DataOnPremise : IData
    {
        private readonly IDataContext dataContext;
        public Expression<Func<Horario, bool>> Filtro { get; private set; }

        public DataOnPremise(IDataContext dataContext, insitedb context)
        {
        ...
        public async Task<IndicadorModel> ObtenerModel(DateTime fecha)
        {
            ...
            return new IndicadorModel
            {
                ...
                Tooltip = "Colaboradores que deben presentarse a laborar en las instalaciones del Grupo SID.",
